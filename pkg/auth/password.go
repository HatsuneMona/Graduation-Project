...
type PasswordAuth interface {
	PasswordWithSaltGenToSHA(password string) string
	PasswordVerify(password string, hashedPassword string) (bool, error)
}
...
//
//@return
//				`hashedPassword string`	加密后的SHA密码
//
//@author       HatsuneMona
...
//@param
//				password 		string 	明文密码；
//				hashedPassword	string 	SHA密码
//@return
//				bool	是否匹配成功；	err	错误信息
//
//@author        HatsuneMona
