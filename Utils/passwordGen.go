...
//@return        hashedPassword []byte	加密后的SHA密码
//@author        HatsuneMona
//@createTime    2021/3/14 10:33
func PasswordWithSaltGenToSHA(password string) []byte {
...
//@param         password string 明文密码；
//@param		 hashedPassword	SHA密码
//@return        bool	是否匹配成功；	err	错误信息
//@author        HatsuneMona
//@createTime    2021/3/14 10:34
func PasswordVerify(password string, hashedPassword []byte) (bool, error) {
